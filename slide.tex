...
\newcommand{\institutename}{Tsinghua University} % <-- and this
...
\AtBeginSection[]{%
  ...
  \ifnum\value{majorsection}>0%
    \begin{frame}[plain]
      \vspace{0.8cm}
      \begin{center}
        {\color{THUPurple}\rule{0.85\textwidth}{1.2pt}}\\[0.6cm]
        {\LARGE\bfseries \insertsection}\\[0.45cm]
        {\color{THUPurple}\rule{0.85\textwidth}{1.2pt}}
      \end{center}
      \vfill
      \begin{center}
...
{%
  ...
  \institute[\institutename]{\institutename\\ Supervisor: Prof.\ Someone}
  \date{}
  \titlegraphic{\includegraphics[width=0.18\linewidth]{Tsinghua_University_Logo.eps}}
  \begin{frame}
      \titlepage
  \end{frame}
}%
    ...
    \begin{columns}
        ...
        \begin{center}
            ...
            \begin{tikzpicture}[scale=0.65, every node/.style={font=\small}]
                ...
                \node[draw, rounded corners, fill=THUPurple!15, minimum width=2.8cm, minimum height=0.8cm, below=0.6cm of input] (enc) {Encoder};
                ...
                \node[draw, rounded corners, fill=THUPurple!15, minimum width=2.8cm, minimum height=0.8cm, below=0.6cm of latent] (dec) {Decoder};
            ...
            \begin{tikzpicture}[scale=0.38]
                \foreach \y in {0,...,7} {
                    \foreach \x in {0,...,5} {
                        ...
                        \fill[THUPurple!\clr] (\x,\y) rectangle (\x+1,\y+1);
...
\begin{frame}{TikZ Flowchart Example}
    ...
    \begin{tikzpicture}[
        ...
        decision/.style={draw, diamond, fill=THUPurple!12,
...
\begin{frame}{}
    ...
    \begin{center}
        ...
        {\normalsize
            \textcolor{AccentBlue}{\textbf{Email}}: your.email@mails.tsinghua.edu.cn\\[0.3cm]
